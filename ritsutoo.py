...
async def add(ctx, *, username):
    ...
    username = username.lower()
    jg = valorant_online.BetteraddPlayer(username, False)
...
async def addonline(ctx, *, username):
    ...
    username = username.lower()
    jg = valorant_online.BetteraddPlayer(username, True)
...
async def remove(ctx, *, username):
    ...
    if ctx.author.id == 410771947522359296:
        ...
        if valorant_online.BetterremovePlayer(username, False) == False:
...
async def removeonline(ctx, *, username):
    ...
    if ctx.author.id == 410771947522359296:
        ...
        if valorant_online.BetterremovePlayer(username, True) == False:
            await ctx.send("Player not in list")
