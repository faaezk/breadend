...
def agraph():
    ...
    while (i + 10) < len(x):
        ...
        j = i
        currmin, currmax, maxindex, minindex = 5000, 0, 0, 0
        ...
        if maxindex > i:
            stuff = minmax_in_range(yint, j, 'max')
            if stuff[0]:
                plt.annotate(ydates[stuff[1]], 
                            xy=(x[stuff[1]], yint[stuff[1]]), 
                            xytext=(x[stuff[1]] - 2.2, yint[stuff[1]] + 20),
                            arrowprops={'arrowstyle' : '->', 'shrinkB' : 5})
            else:
                plt.annotate(ydates[maxindex], 
                            xy=(x[maxindex], yint[maxindex]), 
                            xytext=(x[maxindex] - 2.2, yint[maxindex] + 20),
                            arrowprops={'arrowstyle' : '->', 'shrinkB' : 5})

        if minindex > i:
            stuff = minmax_in_range(yint, j, 'min')
            if stuff[0]:
                plt.annotate(ydates[stuff[1]], 
                            xy=(x[stuff[1]], yint[stuff[1]]), 
                            xytext=(x[stuff[1]] - 2.2, yint[stuff[1]] - 25),
                            arrowprops={'arrowstyle' : '->', 'shrinkB' : 5})
            else:
                plt.annotate(ydates[minindex], 
                            xy=(x[minindex], yint[minindex]), 
                            xytext=(x[minindex] - 2.2, yint[minindex] - 25),
                            arrowprops={'arrowstyle' : '->', 'shrinkB' : 5})
    ...
    if i != len(x):
        if yint[-2] > yint[-1]:
            plt.annotate(ydates[-1], 
                        xy=(x[-1], yint[-1]), 
                        xytext=(x[-1] - 2.6, yint[-1] - 30),
                        arrowprops={'arrowstyle' : '->', 'shrinkB' : 5})
        else:
            plt.annotate(ydates[-1], 
                        xy=(x[-1], yint[-1]), 
                        xytext=(x[-1] - 2.6, yint[-1] + 20),
                        arrowprops={'arrowstyle' : '->', 'shrinkB' : 5}) 
...
def bgraph():
    ...
    if yint[1] > yint[0]:
        plt.annotate(ydates[0], 
                    xy=(x[0], yint[0]), 
                    xytext=(x[0] - 2.2, yint[0] - 30),
    ...
    plt.annotate(ydates[peakMMRIndex], xy=(x[peakMMRIndex], yint[peakMMRIndex]), 
                 xytext=(x[peakMMRIndex] - 2.2, yint[peakMMRIndex] + 30), arrowprops={'arrowstyle' : '->', 'shrinkA' : 1, 'shrinkB' : 4})
    
    bottomMMRIndex = get_index(yint, min(yint))
    plt.annotate(ydates[bottomMMRIndex], xy=(x[bottomMMRIndex], yint[bottomMMRIndex]), 
                 xytext=(x[1] - 2.2, yint[bottomMMRIndex] - 30), arrowprops={'arrowstyle' : '->', 'shrinkA' : 1, 'shrinkB' : 4})
